...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projetcs-gds-123")
    bq_project = Variable.get("bq_project", default_var="data-engineering-453220")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "327869901538-compute@developer.gserviceaccount.com",
                "network_uri": "projects/data-engineering-453220/global/networks/default",
                "subnetwork_uri": "projects/data-engineering-453220/regions/us-central1/subnetworks/default",
            }
        },
    }
